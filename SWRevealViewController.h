...
//ashish : updated
extern NSString* const SWSegueFrontTeacherIdentifier; //this is @"sw_front_teacher"
...
//ashish : added for teacher
@interface SWRevealViewControllerSeguePushTeacherController : UIStoryboardSegue
